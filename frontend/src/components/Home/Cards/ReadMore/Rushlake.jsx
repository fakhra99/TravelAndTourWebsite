...
function Rushlake() {
  return (
    <>
      ...
      <section className="text-gray-600 body-font mt-5 px-5 lg:px-0">
        ...
        <div className="mx-0 sm:mx-5 flex flex-wrap">
          <div className="flex flex-wrap w-full sm:w-2/3">
            ...
            <div className="pl-5 sm:w-full lg:w-1/2 ml-auto -mt-80">
            ...
            <div className="lg:pl-4 sm:w-full sm:pr-5 lg:w-1/2 ml-auto -mt-80">
              <h2 className="title-font font-medium text-2xl text-gray-900">
                Not Included
              </h2>
              <ul className="list-disc pl-5">
          ...
          <div className="pics-section w-full lg:w-1/3 ">
            ...
            <div className=" sm:w-1/3 overflow-hidden mt-5 sm:mt-0 lg:w-full ">
              <img
                ...
                src="https://www.asiaadventurepakistan.com/wp-content/uploads/2023/02/trek-to-rush-lake.jpg"
                alt="stats"
              />
            </div>
            <div className=" sm:w-1/3 overflow-hidden mt-5 sm:mt-0 lg:w-full ">
              <img
                className="object-cover object-right mt-5"
                src="https://www.asiaadventurepakistan.com/wp-content/uploads/2023/02/rush-lake-trek-1.jpg"
                alt="stats"
              />
            </div>
            ...
            <div className=" sm:w-1/3 overflow-hidden mt-5 sm:mt-0 lg:w-full">
              <img
                className="object-cover object-right mt-5"
                src="https://www.asiaadventurepakistan.com/wp-content/uploads/2023/02/rush-lake-trek-pakistan.jpg"
                alt="stats"
              />
            </div>
          </div>
      ...
      <section className="lg:leading-10 text-xl container mx-auto sm:px-0 lg:-mt-96  px-6">
